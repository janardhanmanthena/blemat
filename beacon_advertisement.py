...
def number_to_hex_list(num):
    packed = struct.pack("@h", num)
    hex_list = [int('0x' + format(b, '02x'), 16 ) for b in packed]
    return hex_list[::-1]
...
class TestAdvertisement(Advertisement):
    ...
    def __init__(self, bus, index):
        # UUID 537f381b-837f-4e95-bd42-252a36018211

        company_id =  0x0118
        type =       [0xBE, 0xAC]
        id1 =        [0x53, 0x7f, 0x38, 0x1b, 0x83, 0x7f, 0x4e, 0x95, 0xbd, 0x42, 0x25, 0x2a, 0x36, 0x01, 0x82, 0x11]
        id2 =        [0x00, 0x00]
        id3 =        [0x00, 0x00]
        rssi_at_1m = [0xB3]
        feature  =   [0x00]
